...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Utilisateur} : Constitue le point de départ du système, ce composant représente l'acteur humain qui interagit avec l'application via une interface web ou des appels API, en soumettant des requêtes contenant des stacktraces d'erreur et éventuellement des captures d'écran.
	...
	\begin{thebibliography}{9}  % Le nombre '9' indique le nombre max de références
