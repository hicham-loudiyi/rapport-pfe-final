...
\begin{document}
	...
	\begin{center}
		\begin{minipage}{0.9\textwidth}
			...
			Au début, il m'est agréable d'exprimer ma reconnaissance à toute personne dont l'intervention au cours de ce stage a favorisé son aboutissement.\\[1em]
			
			Remerciements particuliers :\\[0.5em]
			\begin{spacing}{1.2}
				Je tiens à remercier vivement mes encadrants, \\
				Monsieur \textsc{DOUHI Taoufik} et Monsieur \textsc{Mouhib Imad}, \\
				pour leur temps précieux et le partage de leur expertise quotidienne. \\
				Leur confiance m'a permis de développer mes compétences de manière significative.\\[0.8em]
				
				Je remercie Monsieur \textsc{BERAHIOU Radwane} \\
				pour son accueil chaleureux et son accompagnement \\
				dans le suivi du projet au sein d'Algolus.\\[0.8em]
				
				Un grand merci à toute l'équipe d'\textsc{ALGOLUS} \\
				pour m'avoir offert cette opportunité de stage \\
				dans un environnement professionnel stimulant, \\
				et particulièrement à \textsc{ARRHIOUI Karim}, \textsc{ARRHIOUI Anass} \\
				et \textsc{BERHIL Mohammed} pour leurs précieux conseils.\\[0.8em]
			\end{spacing}
			
			Je remercie le corps professoral et administratif \\
			de l'\textsc{École des Hautes Études d'Ingénierie - Oujda} \\
			pour la qualité de la formation reçue.\\[1em]
	...
	\textbf{Mots-clés} : Intelligence artificielle, assistant de débogage, analyse automatique, correction d’erreurs, outil pour développeurs.
	...
	\textbf{Keywords} : Artificial intelligence, debugging assistant, automated analysis, error correction, developer tool.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.1\textwidth]{ds-ai-agent.drawio.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.1\textwidth]{diagramme-rag.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.1\textwidth]{ds-rag.drawio.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.1\textwidth]{scrum.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.1\textwidth]{illustration-graphique.drawio.png}
	...
	\begin{figure}[H]
		\centering
		\fbox{\includegraphics[width=1.1\textwidth]{before-factorisation.png}}
	...
	\begin{figure}[H]
		\centering
		\fbox{\includegraphics[width=1.1\textwidth]{after-factorisation.png}}
	...
	\begin{figure}[H]
		\centering
		\fbox{\includegraphics[width=0.6\textwidth]{structure-projet.png}}
	...
	\begin{figure}[H]
		\centering
		\fbox{\includegraphics[width=0.8\textwidth]{premier-test.png}}
		\caption{\textit{Structure du projet Java}}
	...
	\begin{figure}[H]
		\centering
		\fbox{\includegraphics[width=0.85\textwidth]{swagger-ui.png}}
	...
	\begin{itemize}
		...
		\item Les performances pourraient être optimisées via du caching des analyses récurrentes.
